...
export function Contacto() {
  return (
    <section id="contacto" className="bg-dark-base py-24 text-ivory sm:py-32">
      <Container>
        <Reveal>
        ...
        <Reveal delay={0.15}>
          <div className="mt-10 grid max-w-3xl gap-4 sm:grid-cols-2">
            ...
            <a
              ...
              className="group flex flex-col justify-between rounded-2xl bg-operational-green p-6 text-ivory transition-colors duration-300 hover:bg-[#27604f]"
            >
              ...
              <p className="mt-6 font-mono text-[11px] uppercase tracking-[0.12em] text-ivory/70">
            ...
            <a
              href={MAILTO_URL}
              className="group flex flex-col justify-between rounded-2xl border border-[color:var(--color-hairline-dark)] bg-white/[0.02] p-6 text-ivory transition-colors duration-300 hover:bg-white/[0.05]"
            >
              <div className="flex items-center justify-between gap-3">

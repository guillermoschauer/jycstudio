    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-[1240px] flex-1 flex-col justify-center px-6 pb-10 pt-[calc(var(--header-h)+2rem)] sm:px-8 lg:px-12 lg:pb-12">
        <motion.div variants={container} initial="hidden" animate="visible">
          ...
          {/* Definición de marca, no promesa de beneficio: el hero dice qué
              hacemos y cómo pensamos. El beneficio concreto ("Menos tareas
              manuales…") vive una sola vez, abajo, en Qué hacemos. */}
          <motion.h1
            variants={item}
